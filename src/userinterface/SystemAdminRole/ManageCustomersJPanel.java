...
public class ManageCustomersJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageCustomersJPanel(JLayeredPane adminTaskLayer, FoodDeliverySystem system) {
        initComponents();
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(row == -1){
            JOptionPane.showMessageDialog(this, "Select a customer to delete!", "Select", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private void modifyBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyBtnActionPerformed
        int row = manageTable.getSelectedRow();
        if(row == -1){
            JOptionPane.showMessageDialog(this, "Select a customer to modify!", "Select", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        String username = (String) manageTable.getValueAt(row, 0);
        ModifyCustomerDetailsJPanel mcjp = new ModifyCustomerDetailsJPanel(adminTaskLayer, system, username);
    ...
    private void modifyBtn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyBtn4ActionPerformed
        AddCustomerJPanel acjp = new AddCustomerJPanel(adminTaskLayer, system);
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (Customer cu: system.getCustomerDirectory().getCustomerDirectory()) {
                Object[] c = new Object[5];
                c[0] = cu.getUserName();
                c[1] = cu.getName();
                c[2] = cu.getEmail();
                c[3] = cu.getPhoneNumber();
                c[4] = cu.getHomeAddress();
                model.addRow(c);
        }
