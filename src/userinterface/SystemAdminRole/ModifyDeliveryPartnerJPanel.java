 ...
 */
public class ModifyDeliveryPartnerJPanel extends javax.swing.JPanel {
     ...
     */
    public ModifyDeliveryPartnerJPanel(JLayeredPane adminTaskLayer, FoodDeliverySystem system, String username) {
        initComponents();
        this.adminTaskLayer=adminTaskLayer;
        this.system = system;
        this.username = username;
        deliveryPartner = system.getDeliveryPartnerDirectory().getDeliveryPartner(username);
        populateModifyForm();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("MODIFY DELIVERY PARTNER");
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        deliveryPartner.setPhoneNumber(mobileNumberAsLong);
        system.getDeliveryPartnerDirectory().modifyDeliveryPartner(deliveryPartner);
    ...
    private void populateModifyForm(){
        nameSignUpTextBox.setText(deliveryPartner.getName());
        addressSignUpTextBox.setText(deliveryPartner.getAddress());
        mobileNumberSignUpTextBox.setText(String.valueOf(deliveryPartner.getPhoneNumber()));
        emailSignUpTextBox.setText(deliveryPartner.getEmail());        
    }
}
