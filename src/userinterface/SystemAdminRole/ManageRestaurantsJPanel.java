...
public class ManageRestaurantsJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageRestaurantsJPanel(JLayeredPane adminTaskLayer, FoodDeliverySystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        addBtn.setBackground(new java.awt.Color(92, 184, 92));
        addBtn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        addBtn.setForeground(new java.awt.Color(255, 255, 255));
        addBtn.setText("Add Restaurants");
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(row == -1){
            JOptionPane.showMessageDialog(this, "Select a Restaurant to delete!", "Select", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        AddRestaurantJPanel arjp = new AddRestaurantJPanel(adminTaskLayer, system);
