 ...
 */
public class InComingOrdersJPanel extends javax.swing.JPanel {
     ...
     */
    public InComingOrdersJPanel(JLayeredPane restaurantTaskLayer, FoodDeliverySystem system, Restaurant restaurant) {
        initComponents();
    ...
    private void acceptOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptOrderActionPerformed
        ...
        System.out.println(system.getOrderById(orderId).getTotal());
